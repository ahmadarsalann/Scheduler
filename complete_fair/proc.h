...
struct proc {
	...
	int nice_value;		     // nice value of the process -> default is 0
	/* nice value of -19 has the highest priority, whereas 20 has the lowest priority */
	int weight;	// used in the fair scheduler
	float time_slice;
	float vruntime;
};
